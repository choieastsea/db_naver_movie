...
CREATE TABLE IF NOT EXISTS `naver_movie`.`movie` (
  ...
  `story` VARCHAR(10000) NULL,
  `makingnote` VARCHAR(10000) NULL,
  `aka` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `naver_movie`.`peoole` (
  `peoole_id` INT NOT NULL,
  `name` VARCHAR(90) NULL,
  `people_code` VARCHAR(45) NULL,
  PRIMARY KEY (`peoole_id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `naver_movie`.`movie_appearance` (
  `peoole_peoole_id` INT NOT NULL,
  `movie_movie_code` INT NOT NULL,
  PRIMARY KEY (`peoole_peoole_id`, `movie_movie_code`),
  CONSTRAINT `fk_movie_appearance_mpeoole`
    FOREIGN KEY (`peoole_peoole_id`)
    REFERENCES `naver_movie`.`peoole` (`peoole_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_movie_appearance_mpeoole_idx` ON `naver_movie`.`movie_appearance` (`peoole_peoole_id` ASC) VISIBLE;

CREATE INDEX `fk_movie_appearance_movie1_idx` ON `naver_movie`.`movie_appearance` (`movie_movie_code` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `naver_movie`.` quotes` (
  ...
  `movie_appearance_peoole_peoole_id` INT NOT NULL,
  `movie_appearance_movie_movie_code` INT NOT NULL,
  `quotes` VARCHAR(100) NULL,
  `good` INT NULL,
  PRIMARY KEY (`quotes_id`, `movie_appearance_peoole_peoole_id`, `movie_appearance_movie_movie_code`),
  CONSTRAINT `fk_ quotes_movie_appearance1`
    FOREIGN KEY (`movie_appearance_peoole_peoole_id` , `movie_appearance_movie_movie_code`)
    REFERENCES `naver_movie`.`movie_appearance` (`peoole_peoole_id` , `movie_movie_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_ quotes_movie_appearance1_idx` ON `naver_movie`.` quotes` (`movie_appearance_peoole_peoole_id` ASC, `movie_appearance_movie_movie_code` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `naver_movie`.`casting` (
  ...
  PRIMARY KEY (`casting_id`, `movie_appearance_peoole_peoole_id`, `movie_appearance_movie_movie_code`),
...
CREATE INDEX `fk_casting_movie_appearance1_idx` ON `naver_movie`.`casting` (`movie_appearance_peoole_peoole_id` ASC, `movie_appearance_movie_movie_code` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `naver_movie`.`genre` (
  ...
  `movie_movie_code` INT NOT NULL,
  `name` VARCHAR(45) NULL,
  PRIMARY KEY (`genre_id`, `movie_movie_code`),
