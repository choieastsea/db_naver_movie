...
-- -----------------------------------------------------
-- Table `naver_movie`.`mpeoole`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `naver_movie`.`mpeoole` ;

CREATE TABLE IF NOT EXISTS `naver_movie`.`mpeoole` (
  `mpeoole_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `naver_movie`.`movie_appearance` (
  ...
  CONSTRAINT `fk_movie_appearance_mpeoole`
    ...
    REFERENCES `naver_movie`.`mpeoole` (`mpeoole_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_movie_appearance_mpeoole_idx` ON `naver_movie`.`movie_appearance` (`mpeoole_mpeoole_id` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `naver_movie`.` quotes` (
  ...
  CONSTRAINT `fk_ quotes_movie_appearance1`
    ...
    REFERENCES `naver_movie`.`movie_appearance` (`mpeoole_mpeoole_id` , `movie_movie_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_ quotes_movie_appearance1_idx` ON `naver_movie`.` quotes` (`movie_appearance_mpeoole_mpeoole_id` ASC, `movie_appearance_movie_movie_code` ASC) VISIBLE;
...
CREATE INDEX `fk_casting_movie_appearance1_idx` ON `naver_movie`.`casting` (`movie_appearance_mpeoole_mpeoole_id` ASC, `movie_appearance_movie_movie_code` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `naver_movie`.`country` (
  ...
  `movie_movie_code` INT NOT NULL,
  `name` VARCHAR(45) NULL,
  PRIMARY KEY (`country_id`, `movie_movie_code`),
...
CREATE TABLE IF NOT EXISTS `naver_movie`.`satisfying_netizen` (
  ...
  `statistics_comment` VARCHAR(45) NULL,
